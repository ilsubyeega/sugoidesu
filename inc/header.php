...
<link rel="icon" type="image/assets/icon/png" sizes="192x192"  href="/assets/icon/android-icon-192x192.png">
...
<meta name="theme-color" content="#ef67b1">
  ...
  <!-- General CSS Files -->
  <link rel="stylesheet" href="/assets/css/bootstrap.css" crossorigin="anonymous" type="text/css"/>

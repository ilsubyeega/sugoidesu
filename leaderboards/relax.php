...
$header['button']['url'] = "/leaderboards/normal";
...
$res = $mysqli->query("SELECT  `id`,  `username`,  `total_score_std`, `pp_std`, `avg_accuracy_std`, `playcount_std` FROM `".$mysql_config['db']."`.`rx_stats` ORDER BY `pp_std` DESC LIMIT 100;");
